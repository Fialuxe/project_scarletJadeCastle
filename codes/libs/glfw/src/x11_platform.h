...
typedef struct XkbDescRec *XkbDescPtr;
typedef struct XkbStateRec *XkbStatePtr;
typedef struct XkbEvent XkbEvent;

// The Xinerama extension provides legacy monitor indices
// #include <X11/extensions/Xinerama.h>
typedef struct XineramaScreenInfo XineramaScreenInfo;
